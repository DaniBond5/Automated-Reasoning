from pysmt.shortcuts import And, Equals, Exists, ForAll, Implies, Int, Not, Or, Solver, Symbol
...
# transitivity
assertions.append(ForAll([x, y, z], Implies(And(richer(x, y), richer(y, z)), richer(x, z))))
